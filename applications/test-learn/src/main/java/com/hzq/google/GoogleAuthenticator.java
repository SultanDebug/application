...
public class GoogleAuthenticator {
    ...
    int windowSize = 3; // default 3 - max 17 (from google docs)最多可偏移的时间
    ...
    public static String genQrcode() {
        ...
        System.out.println("二维码秘钥：" + secret);
        String qrBarcodeURL = GoogleAuthenticator.getQRBarcodeURL("testuser",
                "testhost", secret);
        System.out.println("genQrcode二维码地址：" + qrBarcodeURL);
        String decodeQRCodeImage;
        try {
            QrcodeUtil.generateQRCodeImage(qrBarcodeURL, 300, 300);
            decodeQRCodeImage = QrcodeUtil.decodeQRCodeImage();
